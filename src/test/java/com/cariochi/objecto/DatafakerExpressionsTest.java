...
public class DatafakerExpressionsTest {
    ...
    void test() {
        ...
        random.setSeed(1);
        Map<String, String> map = reflect(Datafaker.class).types().stream()
                ...
                .collect(toMap(
                        ...
                        field -> random.strings().datafaker().nextString(field.asStatic().getValue()),
                        (a, b) -> a,
                        TreeMap::new
                ));
