...
public class Nullable implements ConfigFunctionFactory<Generate.Nullable> {

    @Override
    public ConfigFunction createSettings(Generate.Nullable annotation, ReflectoMethod method) {
